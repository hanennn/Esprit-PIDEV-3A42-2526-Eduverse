...
public function setExperience(?string $experience): static
{
    ...
    #[ORM\OneToMany(mappedBy: 'createur', targetEntity: Cours::class, cascade: ['persist', 'remove'], orphanRemoval: true)]
    private Collection $coursCreated;

    /** @var Collection<int, Certification> */
    #[ORM\OneToMany(mappedBy: 'user', targetEntity: Certification::class, cascade: ['persist', 'remove'], orphanRemoval: true)]
    ...
    #[ORM\OneToMany(mappedBy: 'etudiant', targetEntity: DemandeBourse::class, cascade: ['persist', 'remove'], orphanRemoval: true)]
