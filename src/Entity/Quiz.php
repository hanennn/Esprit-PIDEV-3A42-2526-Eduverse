 ...
 */
#[ORM\OneToMany(mappedBy: 'quiz', targetEntity: Certification::class, cascade: ['persist', 'remove'], orphanRemoval: true)]
private Collection $certifications;

/**
 * @var Collection<int, CertificationFinale>
 */
#[ORM\OneToMany(mappedBy: 'quiz', targetEntity: CertificationFinale::class, cascade: ['persist', 'remove'], orphanRemoval: true)]
