...
class DemandeBourse
{
    ...
    #[ORM\OneToOne(mappedBy: 'demandeBourse', targetEntity: AnalyseInterview::class, cascade: ['remove'])]
    private ?AnalyseInterview $analyseInterview = null;
    ...
    public function getAnalyseInterview(): ?AnalyseInterview
    {
        return $this->analyseInterview;
    }

    public function setAnalyseInterview(?AnalyseInterview $analyseInterview): static
    {
        // Set the owning side of the relation if necessary
        if ($analyseInterview !== null && $analyseInterview->getDemandeBourse() !== $this) {
            $analyseInterview->setDemandeBourse($this);
        }

        $this->analyseInterview = $analyseInterview;
