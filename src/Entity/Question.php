...
class Question
{
  ...
  /**
 * @phpstan-var array<int, array{texte: string, correct: bool}>
 */
   ...
   public function getId(): ?int
{
  ...
  /** @return array<int, array{texte: string, correct: bool}> */
public function getReponses(): array
{
    return $this->reponses;
}

/** @param array<int, array{texte: string, correct: bool}> $r */
public function setReponses(array $r): static
{
    $this->reponses = $r;
    return $this;
}
