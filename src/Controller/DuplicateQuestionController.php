...
// Vérification du type pour éviter le cast erroné
if (!is_string($projectDir)) {
    throw new \RuntimeException('Le répertoire du projet n\'est pas une chaîne valide.');
}
...
$aiDir = $projectDir . DIRECTORY_SEPARATOR . 'ai';
        ...
        if ($payload === false) {
            return $this->json(['ok' => false, 'message' => 'Erreur lors de l\'encodage JSON.'], 500);
        }
