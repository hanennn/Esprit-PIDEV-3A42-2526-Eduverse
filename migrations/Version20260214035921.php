 ...
 */
final class Version20260214035921 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `user` (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, nom VARCHAR(100) NOT NULL, prenom VARCHAR(100) NOT NULL, email VARCHAR(100) NOT NULL, is_active TINYINT(1) DEFAULT 1 NOT NULL, date_inscription DATETIME DEFAULT NULL, date_derniere_connexion DATETIME DEFAULT NULL, specialite VARCHAR(255) DEFAULT NULL, experience LONGTEXT DEFAULT NULL, UNIQUE INDEX UNIQ_IDENTIFIER_USERNAME (username), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
